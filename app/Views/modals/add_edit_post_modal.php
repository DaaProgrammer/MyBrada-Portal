          ...
          <div class="card card-plain">
            ...
            <div class="card-body pb-3">
              <form role="form text-left" id="addNewsfeedForm">
                ...
                <img id="image_preview" style="max-width: 200px; margin-top: 10px;" class="mb-3 rounded-3 image_preview" />
          ...
          <div class="card card-plain">
            ...
            <div class="card-body pb-3">
              <form role="form text-left" id="editNewsfeedForm">
                <label>Post Image</label><br/>
                <img id="post_image_edit" style="max-width: 200px; margin-top: 10px;" class="mb-3 rounded-3 image_preview" />
                <div class="input-group mb-3">
                  <input
                    type="hidden"
                    role="uploadcare-uploader"
