          ...
          <div class="card card-plain">
            ...
            <div class="card-body pb-3">
              <form role="form text-left" id="addResponderForm">
                ...
                <div class="form-check form-switch">
                  <input type="checkbox" class="form-check-input" id="responder_status" onchange="changeDispatcherStatus(this.checked)">
                  <label for="responder_status" class="mb-0">Responder status: <span id="addResponderStatus" class="text text-warning">Inactive</span></label>
                </div>
