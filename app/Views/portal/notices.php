                    ...
                    <?php if (!empty($notices) && is_array($notices)) : ?>
                      <?php foreach ($notices as $notice) : ?>
                        ...
                        <tr>
                          ...
                          <td class="align-middle text-center">
                            <div class="ms-auto">
                              <a class="btn btn-link text-success text-gradient mb-0" href="javascript:;" onclick="setEditNoticeDetails('<?= $noticeId ?>', '<?= htmlspecialchars($noticeTitle) ?>', '<?= htmlspecialchars($notice->notice_content ?? '') ?>', '<?= htmlspecialchars($user?->id ?? '') ?>')">
