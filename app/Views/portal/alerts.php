                ...
                <table class="table align-items-center mb-0 datatables">
                  ...
                  <tbody>
                    <?php foreach ($alerts['alerts'] as $alert): ?>
                      <?php
                        $user = $alert->mybrada_users;
                        $responder = $alert->responder_details ?? null;
                        ...
                        $responderName = $responder ? $responder->first_name . ' ' . $responder->last_name : 'N/A';
                        $responderEmail = $responder->email_address ?? 'N/A';
                      ...
                      <tr>
                        <td>
                          <div class="d-flex px-2 py-1">
                            ...
                            <div class="d-flex flex-column justify-content-center">
                              <h6 class="mb-0 text-sm"><?= htmlspecialchars($fullName) ?></h6>
                        ...
                        <td class="align-middle text-center">
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><?= htmlspecialchars($responderName) ?></h6>
                            <p class="text-xs text-secondary mb-0"><?= htmlspecialchars($responderEmail) ?></p>
                          </div>
                        </td>
                        <td class="align-middle text-center">
